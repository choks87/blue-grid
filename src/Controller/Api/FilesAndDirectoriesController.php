...
final class FilesAndDirectoriesController extends AbstractController
{
    ...
    #[OA\Response(response: Response::HTTP_OK, description: 'Getting All Files And Directories.')]
    #[Route('/files-and-directories', name: 'files_and_directories', methods: [Request::METHOD_GET])]
    public function __invoke(#[RequestDto] PaginationDto $paginationDto): JsonResponse
    {
        $criteria = new Criteria(TransformType::TO_ARRAY, $paginationDto);
