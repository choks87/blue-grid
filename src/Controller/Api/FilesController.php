...
final class FilesController extends AbstractController
{
    ...
    #[OA\Response(response   : Response::HTTP_OK, description: 'Getting All Files.')]
    #[Route('/files', name: 'files', methods: [Request::METHOD_GET])]
    public function __invoke(#[RequestDto] PaginationDto $paginationDto): JsonResponse
    {
        $criteria = new Criteria(TransformType::TO_ARRAY_FILES_ONLY, $paginationDto);
